...
class Yii2DataArticle extends \yii\db\ActiveRecord
{
    ...
    {
        return parent::find()->andWhere(['model_id' => Yii::$app->controller->module->id]); // TODO: Change the autogenerated stub
    }
    ...
    public function create($post, $image)
    {
        if(!empty($post)){
            ...
            $this->model_id = Yii::$app->controller->module->id;
            if(!empty($image))
                $this->image = $image;
            $this->save();
        }
